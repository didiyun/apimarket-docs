...
``` shell
curl -X GET \
  'https://map-open-platform.didiglobal.com/api/v1/yawrecovery?route=116.455436,39.944591|116.503729,39.96229|116.548573,39.96583&location=116.480158,39.962733'
```
输出：
``` json
{
